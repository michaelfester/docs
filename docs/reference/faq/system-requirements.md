...
description: The minimum system requirements to build and use Glide projects.
video:
...
{% callout title="Building projects in Glide" %}
We recommend the use of computers in order to build projects in Glide. The use of tablet devices is not recommended.
{% /callout %}
...
{% figure src="/docs/reference/faq/system-requirements/play-page-for-apps.png" caption="The play page for apps viewed on tablet or desktop" /%}
