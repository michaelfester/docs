...
description: Display multiple properties in different styles
...
- And **Background** has six options, **Card**, **Accent**, **Dark**, **White**, **Image**, or **None**.
...
{% figure src="/docs/reference/components/title-component/title-actions-in-pages.png" caption="" /%}
