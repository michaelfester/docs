...
description: Change another row's values.
slug: set-column-values
---

{% figure src="/docs/reference/actions/set-column-values/set-column-values.png" caption="Configuring Set Column Values" /%}
