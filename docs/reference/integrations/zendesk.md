...
{% figure src="/docs/reference/integrations/zendesk/usecase-for-zendesk-integration.png" caption="Use case for Zendesk Integration" /%}
...
{% figure src="/docs/reference/integrations/zendesk/adding-zendesk-integration.png" caption="Adding Zendesk integration" /%}
...
{% figure src="/docs/reference/integrations/zendesk/getting-the-zendesk-api-key.png" caption="Getting the Zendesk key" /%}
...
{% figure src="/docs/reference/integrations/zendesk/zendesk-integration-settings.png" caption="Zendesk Integration settings" /%}
