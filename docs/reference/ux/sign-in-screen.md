...
description: Customize the screen where you users sign in to your app.
video:
slug: sign-in-screen
---
...
{% figure src="/docs/reference/ux/sign-in-screen/default-sign-in.png" caption="Sign-in Screen" /%}
...
{% figure src="/docs/reference/ux/sign-in-screen/text-settings.gif" caption="Text settings" /%}
...
{% figure src="/docs/reference/ux/sign-in-screen/branding.gif" caption="Branding" /%}

![](/docs/reference/ux/sign-in-screen/background-image-load-screen.png)

We can also enable the setting to use your background image in your app's loading screen.

![](/docs/reference/ux/sign-in-screen/background-image-load-screen2.png)
...
{% figure src="/docs/reference/ux/sign-in-screen/user-agreements.png" caption="User Agreements" /%}
